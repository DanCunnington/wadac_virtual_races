 ...
 -->      <div v-if="!refreshing">
        ...
        <div v-if="!manual_submission_submitted && !loading" class="submission-container">
          <div class="strava-option">
            ...
            <p class="submit-instructions strava" v-if="!cookie.access_token && !loading">Note: This application requires access to your activities. The activity name, activity type, start time, distance, elapsed time and moving time of the activity you choose to submit will be stored.</p>
